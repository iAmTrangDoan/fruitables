                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-5"><?= number_format($item['price']) ?> VNĐ</td>
                                            <td class="py-5"><?= $item['quantity'] ?></td>
                                            <td class="py-5"><?= number_format($total) ?> VNĐ</td>
                                        </tr>
                                        <?php endforeach; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-5">
                                                <div class="py-3 border-bottom border-top">
                                                    <p class="mb-0 text-dark"><?= number_format($subtotal) ?> VNĐ</p>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="py-5">
                                                <div class="py-3 border-bottom border-top">
                                                    <p class="mb-0 text-dark">
                                                        <?= number_format($subtotal + 25000.00) ?> VNĐ
                                                    </p>
                                                </div>
                                            </td>
                                        </tr>
