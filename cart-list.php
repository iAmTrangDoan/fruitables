                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="mb-0 mt-4"><?= number_format($total) ?> VNĐ</p>
                                </td>
                                <td>
                        ...
                        <div class="bg-light rounded">
                            <div class="p-4">
                                ...
                                <div class="d-flex justify-content-between mb-4">
                                    ...
                                    <p class="mb-0"><?= number_format($subtotal) ?> VNĐ</p>
                                </div>
                                <div class="d-flex justify-content-between">
                                    <h5 class="mb-0 me-4">Shipping</h5>
                                    <div class="">
                                        <p class="mb-0">Flat rate: 25,000 VNĐ</p>
                                    </div>
                                </div>
                            </div>
                            <div class="py-4 mb-4 border-top border-bottom d-flex justify-content-between">
                                <h5 class="mb-0 ps-4 me-4">Total</h5>
                                <p class="mb-0 pe-4"><?= number_format($subtotal+25000.00) ?> VNĐ</p>
                            </div>
                            <a href="checkout.php"
