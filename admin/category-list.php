                ...
                <div class="card-header">
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="card-tools">
                      <a href="category-add.php" class="btn btn-primary btn-round btn-sm">
                      ...
                      <?php if (!empty($data)): ?>
                        <?php foreach ($data as $category): ?>
                          <tr>
                            ...
                            <td>
                              <a href="category-add.php?id=<?= $category['id']?>" class="btn btn-link btn-primary btn-lg">
                                <i class="fa fa-edit"></i>
                              </a>
                              <form method="post" action="category.php?action=delete" style="display:inline;">
                                <input type="hidden" name="id" value="<?= $category['id'] ?>">
                                <button type="submit" class="btn btn-link btn-danger btn-lg" onclick="return confirm('Are you sure you want to delete this category?')">
