                    ...
                    <div class="card-body">
                         <form method="post">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="id" value="<?= $category['id'] ?? 'Auto' ?>" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="name" class="form-label">Name</label>
                                <input type="text" class="form-control" id="name" value="<?= htmlspecialchars($category['name'] ?? '') ?>" required>
                            </div>
                            <div class="mb-3">
